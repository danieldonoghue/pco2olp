...
Place screenshot and image files here. File names referenced in the documentation:

| File | Page | Description |
|---|---|---|
| `logo.svg` | All pages (sidebar + index) | App icon / logo |
| `main-window.png` | Using the App | Main window with a plan loaded, items with checkboxes, generate button |
| `settings.png` | Settings | Full settings dialog showing all sections |
